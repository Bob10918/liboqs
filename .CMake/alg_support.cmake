...
option(OQS_ENABLE_KEM_LEDACRYPT "Enable LEDAcrypt algorithm family" ON)
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_23371 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_23371_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_23371" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_16067 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_16067_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_16067" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_13397 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_13397_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_13397" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_28277 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_28277_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_28277" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_19709 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_19709_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_19709" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_16229 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_16229_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_16229" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_40787 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_40787_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_40787" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_28411 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_28411_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_28411" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_22901 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_22901_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_22901" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_52667 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_52667_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_52667" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_36629 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_36629_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_36629" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_30803 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_30803_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_30803" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_61717 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_61717_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_61717" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_42677 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_42677_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_42677" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_35507 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_35507_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_35507" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_83579 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_83579_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_83579" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_58171 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_58171_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_58171" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_48371 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_48371_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_48371" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_10883 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_10883_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_10883" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_8237 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_8237_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_8237" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_7187 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_7187_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_7187" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_21011 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_21011_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_21011" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_15373 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_15373_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_15373" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_13109 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_13109_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_13109" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_35339 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_35339_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_35339" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_25603 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_25603_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_25603" OFF)
    endif()
endif()
cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_21611 "" ON "OQS_ENABLE_KEM_LEDACRYPT" OFF)
if(CMAKE_SYSTEM_NAME MATCHES "Linux|Darwin")
    if(OQS_DIST_X86_64_BUILD OR OQS_USE_AVX2_INSTRUCTIONS)
        cmake_dependent_option(OQS_ENABLE_KEM_ledacrypt_cpa_21611_avx2 "" ON "OQS_ENABLE_KEM_ledacrypt_cpa_21611" OFF)
    endif()
endif()
