...
void OQS_KEM_LEDACRYPT_CPA_13109_CLEAN_gf2x_transpose_in_place(DIGIT
...
#define GF2X_DIGIT_MOD_INVERSE OQS_KEM_LEDACRYPT_CPA_13109_CLEAN_gf2x_mod_inverse
int OQS_KEM_LEDACRYPT_CPA_13109_CLEAN_gf2x_mod_inverse(DIGIT out[], const DIGIT in[]);
/*----------------------------------------------------------------------------*/
