 ...
 */
int OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_crypto_kem_keypair( unsigned char *pk,
                                      unsigned char *sk )
{

    OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_key_gen_niederreiter((publicKeyNiederreiter_t *) pk,
 ...
 */
int OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_crypto_kem_enc( unsigned char *ct,
                                  unsigned char *ss,
                                  const unsigned char *pk )
{

    OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_encrypt_niederreiter_indcpa((unsigned char *const) ct,
 ...
 *           ss is the shared secret
 */
int OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_crypto_kem_dec( unsigned char *ss,
                                  const unsigned char *ct,
                                  const unsigned char *sk )
{
   int decryption_ok;
   decryption_ok = (1 == OQS_KEM_LEDACRYPT_CPA_25603_CLEAN_decrypt_niederreiter_indcpa((unsigned char *const) ss,
