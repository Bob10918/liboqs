...
void OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_left(DIGIT *in);
void OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_right(DIGIT *in);
...
void gf2x_mod(DIGIT out[], const DIGIT in[])
{
   ...
   memcpy(aux, in, (NUM_DIGITS_GF2X_ELEMENT+1)*DIGIT_SIZE_B);
    ...
    OQS_KEM_LEDACRYPT_23371_CLEAN_right_bit_shift_n(NUM_DIGITS_GF2X_ELEMENT + 1, aux,
...
void OQS_KEM_LEDACRYPT_23371_CLEAN_gf2x_transpose_in_place(DIGIT *A)
{
   ...
   if (slack_bits_amount)
       OQS_KEM_LEDACRYPT_23371_CLEAN_right_bit_shift_n(NUM_DIGITS_GF2X_ELEMENT, A, slack_bits_amount);
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_left
...
void OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_right(DIGIT *in)   /*  x^{-1} * in(x) mod x^P+1 */
{
   ...
   in[0] |= rotated_bit;
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_right
...
int OQS_KEM_LEDACRYPT_23371_CLEAN_gf2x_mod_inverse(DIGIT *out, const DIGIT *in)     /* in^{-1} mod x^P-1 */
{
   ...
   for (i = 1; i <= 2*P; i++) {
      if ( (f[0] & mask) == 0 ) {
         left_bit_shift(NUM_DIGITS_GF2X_MODULUS, f);
          OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_left(u);
         delta += 1;
      } else {
         if ( (s[0] & mask) != 0) {
         ...
         if ( delta == 0 ) {
            ...
            delta = 1;
             ...
             OQS_KEM_LEDACRYPT_23371_CLEAN_rotate_bit_right(u);
            delta = delta - 1;
         }
      }
   }
   ...
   return (delta == 0);
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_gf2x_mod_inverse
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_gf2x_mod_mul
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_gf2x_transpose_in_place_sparse
...
} // OQS_KEM_LEDACRYPT_23371_CLEAN_rand_circulant_sparse_block
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_rand_error_pos
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_rand_error_pos_shake
