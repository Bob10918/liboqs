...
void OQS_KEM_LEDACRYPT_23371_CLEAN_encrypt_niederreiter_indcca2(unsigned char *const
                                  ...
                                  const publicKeyNiederreiter_t *const pk)
{
   ...
   DIGIT error_vector[N0*NUM_DIGITS_GF2X_ELEMENT];
    OQS_KEM_LEDACRYPT_23371_CLEAN_expand_error(error_vector, errorPos);
...
} // end OQS_KEM_LEDACRYPT_23371_CLEAN_encrypt_niederreiter_indcca2
