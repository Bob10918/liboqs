...
int OQS_KEM_LEDACRYPT_61717_CLEAN_thresholds[2] = {B0, (V)/2+1};


int OQS_KEM_LEDACRYPT_61717_CLEAN_bf_decoding(DIGIT out[], // N0 polynomials
...
#error The circulant block size should exceed 64
   ...
   do {
      ...
      int corrt_syndrome_based= OQS_KEM_LEDACRYPT_61717_CLEAN_thresholds[iteration];
