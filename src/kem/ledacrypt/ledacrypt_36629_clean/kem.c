                                     ...
                                     uint8_t *sk )
{
    ...
    OQS_KEM_LEDACRYPT_36629_CLEAN_key_gen_niederreiter((publicKeyNiederreiter_t *const) pk,
                                 ...
                                 const uint8_t *pk )
{
    ...
    OQS_KEM_LEDACRYPT_36629_CLEAN_encrypt_niederreiter_indcca2((unsigned char *const) ct, /* ciphertext - output   */
                                                (unsigned char *const) ss,  /* shared secret - output*/
                                                (const publicKeyNiederreiter_t *const) pk);

   return 0; // NIST convention: 0 == zero errors
} //end OQS_KEM_LEDACRYPT_36629_CLEAN_crypto_kem_enc
                                 ...
                                 const uint8_t *sk)
{
    ...
    OQS_KEM_LEDACRYPT_36629_CLEAN_decrypt_niederreiter_indcca2((unsigned char *const) ss,
