...
__attribute__((noinline))
static void OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power(int32 *x,long long n,int flagdown)
{
   long long p,q,i,j,k;
   int32x8 mask;
   ...
   if (n == 32) {
      ...
      OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power(x,16,1);
      OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power(x + 16,16,0);
...
void OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort(int32 *x,long long n)
{
   long long q,i,j;
   ...
   if (!(n & (n - 1))) {
      OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power(x,n,0);
      return;
   }
   ...
   if (q <= 128) { /* n <= 256 */
      ...
      OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power((int32 *) y,2*q,0);
      for (i = 0; i < n; ++i) x[i] = i[(int32 *) y];
      return;
   }

   OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort_2power(x,q,1);
   OQS_KEM_LEDACRYPT_40787_AVX2_int32_sort(x + q,n - q);
